# Lil Ant Game
This project is a fun game based on the [MonoGame library](https://www.monogame.net/). The library lets you create cross-platform games by offering features such as: game frameworks, 2D rendering and handing user inputs. 
